            ...
            try:
                with open(path, 'r', encoding='utf-8') as f:
                    ...
                    obj = np.array([
                        ...
                        safe_float(fit.get("light_source_fitness", {}).get("fitness", 0)),
                        safe_float(fit.get("environment_fitness", {}).get("fitness", 0)),
                        safe_float(fit.get("light_intensity_inconsistency", {}).get("fitness", 0))
                    ])
    ...
    def filter(self):
        ...
        for i, file_name in enumerate(json_files):
            ...
            try:
                ...
                raw_score = data.get("fitness", {}).get("light_intensity_inconsistency", {}).get("fitness", 0)
                try:
