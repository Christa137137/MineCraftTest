...
class SeedMutation:
    ...
    def __init__(self, input_path=None, output_path=None, max_workers=10):
        ...
        self.mutation_prompt_path = "src/test/lighttest/seedmutation/seedmutation_prompt.json"
        self.llm = LLM()
    ...
    def mutate_single_file(self, file_name):
        ...
        try:
            ...
            energy = 1 # or energy = math.ceil(3 * total_fitness)
    ...
    def assemble_mutation_prompt(self, seed_data):
        ...
        with open('src/test/lighttest/object_id.json', 'r', encoding='utf-8') as f:
            object_ids = f.read()
        ...
        guidance = ""
        keys = ["media_complexity", "light_source_fitness", "environment_fitness", "light_intensity_inconsistency"]
        for key in keys:
        ...
        history = []
        if os.path.exists("outputs/inconsistent_seeds/lighttest/used_slugs.json"):
            with open("outputs/inconsistent_seeds/lighttest/used_slugs.json", 'r', encoding='utf-8') as f:
                history = json.load(f)
