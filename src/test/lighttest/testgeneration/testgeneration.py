...
from src.test.lighttest.mechanicgen.mechanicgen import MechanicGen
...
class TestGeneration():
    ...
    def __init__(self, output_path=None, initial_seed_num=1, max_workers=10):
        ...
        self.testgeneration_prompt_path = "src/test/lighttest/testgeneration/testgeneration_prompt.json"
        self.llm = LLM()
