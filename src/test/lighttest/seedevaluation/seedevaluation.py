...
class SeedEvaluation:
    ...
    def evaluate_single_file(self, file_name, prompt_template):
        ...
        try:
            ...
            inc_fit = temp_data["fitness"].get("light_intensity_inconsistency", {})
            inc_fit_score = 0.0
            try:
    ...
    def assemble_evaluation_prompt(self, template, input_data):
        ...
        with open(f'src\\test\\{current_mode}\\object_id.json', 'r', encoding='utf-8') as f:
            object_ids = f.read()
